...
function VideoOverlayApp() {
  ...
  async function updateServer() {
    const response = await ky.get("https://hubapi.quakeworld.nu/v2/servers/mvdsv?has_client=[streambot]")
  ...
  return (
    <div className={classNames("h-full flex items-center justify-center animate-opacity duration-500", {
      "opacity-100": visible,
      "opacity-0": !visible,
    })}
      ...
      <div className="p-4 bg-black/80 rounded-lg">{
        server && (
          <div className="space-y-4">
            ...
            <div>
              <img src={`https://www.quakeworld.nu/images/flags/${server.geo.cc.toLowerCase()}.gif`} width={16}
                   height={11} className="inline" /> {server.address}
            </div>
            ...
            <div className="flex space-x-4 text-sm text-sky-600">
              ...
              <a href={`https://maps.quakeworld.nu/all/${server.settings.map}.bsp`}>Download map</a>
            </div>
